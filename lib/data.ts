...
export const currentContext = {
  conference: "Seattle Filipino Basketball League",
  season: "Summer 2026",
  division: "Division A",
  team: "Team Kada",
};
...
export const games: Game[] = [
  {
    ...
    time: "6:30 PM",
    opponent: "Seattle Ballers",
    venue: "Kada Court Center",
    court: "Court 2",
    side: "Home",
    uniform: "White",
  },
  ...
  },
  {
    ...
    month: "SEP",
    date: "06",
    dateLabel: "Sunday, Sep 06",
    time: "5:00 PM",
    opponent: "Manila Kings",
    venue: "Kada Court Center",
    court: "Court 3",
    side: "Home",
    uniform: "Dark",
  },
  {
    ...
    month: "SEP",
    date: "13",
    dateLabel: "Saturday, Sep 13",
    time: "7:00 PM",
    opponent: "Bellevue Elite",
    venue: "Kada Court Center",
    court: "Court 2",
    side: "Home",
    uniform: "White",
  },
  {
    ...
    month: "SEP",
    date: "20",
    dateLabel: "Saturday, Sep 20",
    time: "6:00 PM",
    opponent: "Rain City Hoops",
    venue: "Kada Court Center",
    court: "Court 1",
    side: "Home",
    uniform: "Dark",
...
export const currentPlayer: PlayerView = {
  id: "KCH-028",
  name: "Paul Lazarte",
  initials: "PL",
  status: "Active Player",
  mobile: "(425) 555-0128",
  email: "paul.lazarte@example.com",
  birthdate: "May 12, 1975",
  birthdateValue: "1975-05-12",
...
export const fees: Fee[] = [
  { id: "league", label: "League Fee", amount: 110, icon: "◉" },
  { id: "uniform", label: "Uniform Fee", amount: 60, icon: "♕" },
];

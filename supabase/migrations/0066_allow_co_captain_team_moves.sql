...
declare v_conference_id uuid;v_source_team_id uuid;v_source_division_id uuid;v_target_division_id uuid;v_role text;
begin
  select season.conference_id,registration.team_id,registration.division_id,registration.role_label
  into v_conference_id,v_source_team_id,v_source_division_id,v_role
  ...
  if v_role='Captain' then raise exception 'Captains cannot be moved with this control.'; end if;

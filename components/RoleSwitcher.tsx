  ...
  return (
    ...
    >
      ...
      >
        {index >= 0 && (
          <i
            className="absolute top-1 bottom-1 left-1 w-[calc((100%_-_8px_-_(var(--role-count)_-_1)_*_6px)/var(--role-count))] translate-x-[calc(var(--role-index)_*_(100%_+_6px))] rounded-[11px] bg-[#08254a] shadow-[0_3px_10px_#08254a33] transition-[translate] duration-[240ms] ease-[cubic-bezier(0.4,0,0.2,1)] motion-reduce:transition-none"
            aria-hidden="true"
          />
        )}

  ...
  return (
    <section className="card rules-document">
      <header>
        ...
        <div>
          <h2>{ownerDemoOverviewTitle}</h2>
          <p>KCH Demo Overview · Free evaluation</p>
        </div>
      </header>
      <article>
        <section>
          ...
          <p>
            ...
            player directory, rosters, schedules, scores, standings, uniforms, and league-fee
            records. You can invite players, assign captains and co-captains, and give members
            access to view their team and schedule.
          </p>
        </section>
        <section>
          <h3>Free Demo</h3>
        ...
        <section>
          ...
          <p>
            You remain in charge of your conference. You decide your league rules, player
            eligibility, league fees, venues, teams, schedules, and on-court decisions. KCH provides
            the tools to help you organize and share that information with your members.
          </p>
          <p>

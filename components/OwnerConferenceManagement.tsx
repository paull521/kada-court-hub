...
export default function OwnerConferenceManagement({
  ...
  return (
    <section className="owner-conference-management">
      <div className="conference-create-card card">
      ...
      <section className="conference-list-section">
        ...
        <div className="conference-choice-list">
          {conferences.map((conference) => (
            <form
              action={selectOwnerConferenceAction}
              key={conference.id}
              className={`conference-choice card ${conference.id === currentId ? "selected" : ""}`}
            >
              ...
              <button className="btn secondary" disabled={conference.id === currentId}>

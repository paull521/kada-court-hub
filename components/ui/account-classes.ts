...
/** Payments' own history disclosure, and the platform's copy of it. */
export const historyPanel =
  "group mt-[18px] overflow-hidden [&>summary]:grid [&>summary]:min-h-[64px] [&>summary]:cursor-pointer [&>summary]:list-none [&>summary]:grid-cols-[35px_1fr_auto] [&>summary]:items-center [&>summary]:gap-[10px] [&>summary]:p-[13px_16px] [&>summary::-webkit-details-marker]:hidden [&>summary>span]:text-[23px] [&>summary>span]:text-muted [&>summary>b]:text-base [&>summary>strong]:text-2xl [&>summary>strong]:transition-transform group-open:[&>summary>strong]:rotate-90 [&>h2]:m-[0_0_5px] [&>h2]:text-sm [&>h2]:text-gold";

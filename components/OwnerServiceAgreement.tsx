...
export function OwnerServiceAgreement() {
  return (
    <RulesDocument
      ...
      title="KCH Owner Service Agreement"
      meta="Future paid season reference"
      footer={
        <footer>
          <b>Draft Agreement</b>
    ...
    >
      <section>
        ...
        <p>
          The Owner operates the conference independently and remains responsible for league rules,
          venues, team participation, player collections, and conference decisions.
        </p>
      </section>
      <section>
      ...
      <section>
        ...
        <p>
          ...
          protect account credentials; obtain needed participant permissions; and remain responsible
          for player fees, refunds, venue arrangements, insurance, rules, and on-court conduct.
        </p>
      </section>
      <section>
        <h3>6. Data and Promotion</h3>
        <p>
          KCH keeps conference information separated through access controls and may access it only
          as reasonably necessary to provide, administer, secure, or support the service. KCH will
          ask before using a conference name, logo, photograph, or testimonial for promotion.
        </p>
      </section>
      <section>
        ...
        <p>
          ...
          obligations. KCH may retain reasonable account, payment, and historical conference records
          for administration, legal compliance, security, and service continuity.
        </p>
      </section>
    </RulesDocument>
  );

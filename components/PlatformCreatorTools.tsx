...
const ownerPricingTerms="The $100 new-owner setup fee is waived during the initial pilot season. After the pilot, each season includes a $50 Season Subscription plus $3 for each active player in each division. Owners set their own league fees and handle player collections.";

...
export default function RulesAcknowledgmentForm({
  ...
  return (
    <form action={action} className="rules-acknowledgment">
      ...
      <p>
        I acknowledge that I have been provided access to these League Rules &amp; Discipline
        policies. I understand that my participation is subject to these rules and agree to follow
        the applicable league requirements and standards of conduct.
      </p>
      ...
      <button className="btn primary" disabled={pending || !acknowledged}>
        {pending ? "Joining…" : "Acknowledge & Join Season"}
      </button>
    </form>
  );
}

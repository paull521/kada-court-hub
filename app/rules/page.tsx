...
export default async function RulesPage({searchParams}:{searchParams:Promise<{invitation?:string;acknowledgment?:string}>}){
  ...
  const acknowledging=Boolean(params.invitation&&!record.acknowledged_at);

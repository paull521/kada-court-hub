...
export default async function Profile({searchParams}:{searchParams:Promise<{view?:string}>}){
  ...
  const[{data:rulesAcknowledgments},{data:requiredRules}]=await Promise.all([supabase.rpc("get_player_rule_acknowledgments"),supabase.rpc("get_required_rule_acknowledgment")]);

...
/**
 * Rendered instantly while /my-team resolves its server data. The real bottom nav
...
export default function Loading() {
  return (
    <AppShell active="team" headerAction={<SkeletonChip />} headerNotification={<SkeletonBell />}>

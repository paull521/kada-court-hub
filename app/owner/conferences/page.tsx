...
export default async function OwnerConferencesPage(){
  ...
  return <OwnerPageShell title="Conferences" subtitle="Create an isolated test conference or switch owner workspaces." active="more"><OwnerConferenceManagement currentId={data.conferenceId} conferences={data.conferences}/></OwnerPageShell>;
}

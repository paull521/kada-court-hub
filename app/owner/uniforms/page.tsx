...
export default async function OwnerUniformsPage(){
  ...
  return <OwnerPageShell title="Uniforms" subtitle="Dark and light reference photos, organized by season." active="more" conferenceName={data.conferenceName}><OwnerUniformManagement seasons={data.seasons}/></OwnerPageShell>;
}

...
export default async function OwnerSchedulePage(){
  ...
  return <OwnerPageShell title="Schedule" subtitle="Create, update, and finalize regular-season and playoff schedules." active="schedule" conferenceName={data.conferenceName}><OwnerGameManagement seasons={data.seasons}/></OwnerPageShell>;
}

...
export default async function OwnerFinancialsPage(){
  ...
  return <OwnerPageShell title="Financial Summary" subtitle="Track season income, expenses, and profit or loss." active="more"><OwnerFinancialSummary seasons={data.seasons} groups={data.paymentGroups} financials={data.financials}/></OwnerPageShell>;
}

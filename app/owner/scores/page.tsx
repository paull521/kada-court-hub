...
export default async function OwnerScoresPage(){
  ...
  return <OwnerPageShell title="Scoresheets" subtitle="Post final scores without the schedule-management clutter." active="home"><OwnerScoresheets seasons={data.seasons}/></OwnerPageShell>;
}
